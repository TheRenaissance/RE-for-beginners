...
The reason this happens is a quirk in the architecture of some RISC \ac{ISA}s and isn't important for our purposes\footnote{Those interested can find more information at http://en.wikipedia.org/wiki/Delay_slot#Branch_delay_slots}
---we must simply keep in mind that in MIPS, the instruction following a jump or branch instruction
